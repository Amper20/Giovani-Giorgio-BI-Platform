...
if __name__ == "__main__":
    ...
    training_set = restaurant_training_set.groupby(pd.Grouper(key='Order Date', axis=0, freq='1D', sort=True))["Product Price"].sum()
    training_set = training_set.iloc[:].values.reshape(1434,1)
    ...
    a_file = open("data_processed.pkl", "wb")
